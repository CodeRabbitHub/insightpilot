...
# answer() -> generate_sql() makes two real Voyage embed calls per
# invocation (schema + glossary retrieval) plus one real Anthropic call
# -- a 2026-08-03 retest found no evidence of the free-tier 3 RPM cap
# this timeout was previously padded for, so it's back to a value that
# matches real observed single-invocation latency with margin.
